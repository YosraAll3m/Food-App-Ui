...
class inboxCard extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          CircleAvatar(backgroundColor: Colors.deepOrange,radius: 6,),
          SizedBox(width: 10,),
          Column(
            children: [
              Text("Meal Monkey Promotions", style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20),),
              SizedBox(height: 4,),
              Text("Lorem ipsum dolor sit amet, consectetur\n adipiscing elit, sed do eiusmod tempor", style: TextStyle(color: Colors.black,fontSize: 15),)
